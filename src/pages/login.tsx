    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (profile.role !== "super_admin") {
                ...
                if (userRecordError) {
                    console.error("User record query error:", userRecordError);
                }

                if (!userRecord?.company_id && profile.role === "company_owner") {
                    console.log("Company owner has no company yet, redirecting to onboarding");
