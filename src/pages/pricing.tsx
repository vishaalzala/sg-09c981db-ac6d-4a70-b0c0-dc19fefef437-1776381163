...
export default function PricingPage() {
    ...
    useEffect(() => {
        getPublicPlans({ placement: "pricing" }).then((rows) => {
                                    ...
                                    <CardContent className="space-y-6">
                                        ...
                                        <div className="grid gap-2">
                                            <Button className="w-full" variant={highlight ? "default" : "outline"} asChild>
                                                <Link href={`/signup?plan=${plan.id}&billingCycle=monthly`}>Start free trial</Link>
                                            </Button>
                                            <p className="text-center text-xs text-muted-foreground">Trial starts monthly. Annual billing can be selected after upgrade.</p>
                                        </div>
                                    </CardContent>
                                </Card>
                            );
