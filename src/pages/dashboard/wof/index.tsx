...
export default function WOFInspections() {
    ...
    const filteredInspections = inspections.filter((inspection) => {
        const vehicleInfo =
            `${inspection.vehicles?.registration || ""} ${inspection.vehicles?.make || ""} ${inspection.vehicles?.model || ""}`.toLowerCase();
                            ...
                            <TableBody>
                                {filteredInspections.map((inspection) => (
                                    ...
                                    >
                                        ...
                                        <TableCell>
                                            {inspection.vehicles?.registration} - {inspection.vehicles?.make}{" "}
                                            {inspection.vehicles?.model}
                                        </TableCell>
                                        <TableCell>{inspection.customers?.name || "N/A"}</TableCell>
                                        ...
                                        <TableCell>
                                            <Button
                                                ...
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                    router.push(`/dashboard/wof/${inspection.id}`);
                                                }}
                                            >
                                                View
                                            </Button>
