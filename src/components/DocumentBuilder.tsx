                ...
                <div className="flex items-start justify-between gap-4">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight text-slate-900">
                            {type === "invoice" ? "New Invoice" : "New Quote"}
                        </h1>
                        <p className="mt-1 text-sm text-slate-500">
                            Enter customer, vehicle, and document details to begin.
                        </p>
                    </div>
                </div>
                    ...
                    <Card className="rounded-xl border border-slate-200 bg-white shadow-sm">
                        <CardContent className="p-6">
                            <div className="space-y-6">
                                <h2 className="border-b pb-3 text-xl font-bold text-slate-900">Customer & Vehicle Details</h2>
                    ...
                    <Card className="rounded-xl border border-slate-200 bg-white shadow-sm">
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between mb-4 border-b pb-3">
                                <h2 className="text-xl font-bold text-slate-900">Matching Results</h2>
    ...
    return (
        <div className="mx-auto w-full max-w-[1560px] space-y-5 p-6">
            <div className="flex items-start justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-slate-900">
                        {type === "invoice" ? "Invoice Builder" : "Quote Builder"}
                    </h1>
                    <p className="mt-1 text-sm text-slate-500">
                        Manage customer, vehicle, items, payment, and follow-up in one place.
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-5 xl:grid-cols-[minmax(0,2fr)_380px]">
                ...
                <Card className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div className="flex gap-2 mb-3">
                        <Button size="sm" className="rounded-lg bg-[#123E97] text-white hover:bg-[#0f327c]" onClick={addLineItem}>
                            <Plus className="h-4 w-4 mr-1" />
                            Item
                        </Button>
                        <Button size="sm" variant="outline" className="rounded-lg border-slate-300" onClick={addHeader}>
                            <Plus className="h-4 w-4 mr-1" />
                            Header
                        </Button>
                        <Button size="sm" variant="outline" className="rounded-lg border-slate-300" onClick={() => setShowJobTypeDialog(true)}>
                            <Plus className="h-4 w-4 mr-1" />
                            Job Tyres / Job Kit
                        </Button>
                    </div>
                    ...
                    {/* Items Table */}
                    <div className="mb-4 overflow-auto rounded-xl border border-slate-200 bg-white">
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="border-b bg-slate-50">
                                    <th className="px-4 py-3 text-left text-[11px] font-bold uppercase tracking-[0.06em] text-slate-500">Item</th>
                                    <th className="px-4 py-3 text-left text-[11px] font-bold uppercase tracking-[0.06em] text-slate-500">Description</th>
                                    <th className="px-4 py-3 text-left text-[11px] font-bold uppercase tracking-[0.06em] text-slate-500">Qty</th>
                                    <th className="px-4 py-3 text-left text-[11px] font-bold uppercase tracking-[0.06em] text-slate-500">Rate</th>
                                    <th className="px-4 py-3 text-left text-[11px] font-bold uppercase tracking-[0.06em] text-slate-500">Discount</th>
                                    <th className="px-4 py-3 text-left text-[11px] font-bold uppercase tracking-[0.06em] text-slate-500">Total</th>
                                    <th className="px-4 py-3 text-left text-[11px] font-bold uppercase tracking-[0.06em] text-slate-500">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                {lineItems.length === 0 && (
                                ...
                                {lineItems.map((item) => (
                                    <tr
                                        ...
                                        className={cn("cursor-move border-b last:border-b-0 hover:bg-slate-50/80", draggedItem === item.id && "opacity-50")}
                                    >
                                        <td className="p-3">
                ...
                <div className="space-y-4 xl:sticky xl:top-20 xl:self-start">
                    ...
                    <Card className="rounded-xl border border-orange-200 bg-orange-50/60 p-4 shadow-sm">
            ...
            <Card className="sticky bottom-4 z-20 rounded-2xl border border-slate-200 bg-white/95 p-4 shadow-lg backdrop-blur">
                <div className="flex flex-wrap items-center justify-between gap-3">
                    <div className="flex gap-2">
                        <Button variant="outline" className="rounded-lg" onClick={handleSaveDocument} disabled={loading}>
                            Save Draft
                        </Button>
                        <Button variant="outline" className="rounded-lg">Send</Button>
                        <Button variant="outline" className="rounded-lg">Print</Button>
                        <Button variant="outline" className="rounded-lg">Delete</Button>
                    </div>
                    <div className="flex gap-2">
                        <Button variant="outline" className="rounded-lg" onClick={handleHold}>
                            Hold
                        </Button>
                        <Button className="rounded-lg bg-green-700 hover:bg-green-800" onClick={() => setShowFinishModal(true)}>
                            Finish Job
                        </Button>
                        <Button className="rounded-lg bg-orange-600 hover:bg-orange-700" onClick={() => setShowPayModal(true)}>
                            Pay
                        </Button>
                    </div>
                </div>
            ...
            <Dialog open={showPayModal} onOpenChange={setShowPayModal}>
                <DialogContent className="max-w-3xl">
                    ...
                    <DialogFooter>
                        ...
                        <Button className="rounded-lg bg-orange-600 hover:bg-orange-700" onClick={handlePay}>Pay</Button>
                        <Button className="rounded-lg bg-green-700 hover:bg-green-800">Pay & Print</Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
